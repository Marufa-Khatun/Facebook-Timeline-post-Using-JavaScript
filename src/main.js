...
const fb_post_timeline = document.querySelector(".user-post");
...
if(posts){
    ...
    posts.reverse().forEach((item,index)=>{
        ...
        <div class="user-post-header">
              ...
              <div  >
              <button data-bs-toggle="modal" data-bs-target="#post-update"
              onclick="modalEdit('${item.id}')"> <i class="fa-regular fa-pen-to-square"></i> </button>
              <button onclick="deletePost('${item.id}')"> <i class="fa-regular fa-trash-can"></i> </button>
              </div>
    ...
    fb_post_timeline.innerHTML=posts_data;
...
const modalEdit =(id)=>{
  ...
  post_update_form.querySelector('input[placeholder="Author Name"]').value=name;
  post_update_form.querySelector('input[placeholder="Author Photo"]').value=photo;
  post_update_form.querySelector('textarea[placeholder="Post Content"]').value=post;
  post_update_form.querySelector('input[placeholder="Post Photo"]').value=post_photo;
  post_update_form.querySelector('input[placeholder="ID"]').value=id;
